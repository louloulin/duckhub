    ...
    cfg
        ...
        .service(
            web::scope("/api/v1/ducklake")
                ...
                .route("/databases/{id}/connect", web::post().to(connect_database))
                .route("/databases/{id}/detach", web::post().to(detach_database))
                .route("/databases/{name}/snapshots", web::get().to(list_snapshots))
                .route("/databases/{name}/snapshots", web::post().to(create_snapshot))
